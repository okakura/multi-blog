...
-- This script will rebuild the user_sessions table with the correct structure
...
-- Remove session_id column from analytics_events if it exists
...
INSERT INTO _sqlx_migrations (version, description, checksum, execution_time, success)
VALUES 
    (4, 'add session tracking', decode('abc123', 'hex'), 1, true),
    (5, 'cleanup session tracking', decode('def456', 'hex'), 1, true),
    (6, 'skip migration 4', decode('ghi789', 'hex'), 1, true)
