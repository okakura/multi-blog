...
// Simple default config since we're removing domain-specific theming for now
const defaultConfig = {
...
const BlogPostPage: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br ${defaultConfig.theme.primary} relative overflow-hidden`}>
      ...
      <div
        ...
        <div className='relative z-10 flex items-center justify-center min-h-screen'>
          <div className='max-w-md mx-auto px-6'>
            ...
            />
            <button
              onClick={() => navigate(`/blog/${domain || 'default'}`)}
            ...
            <header className='p-8 pb-6 border-b border-gray-100'>
              ...
              <div className='mb-4'>
                <span
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${defaultConfig.theme.accent}, ${defaultConfig.theme.accent}CC)`,
                  }}>
                  <Tag size={12} />
                  {post.category}
                </span>
