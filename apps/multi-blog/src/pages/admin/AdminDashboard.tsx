        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-3'>
            <button
              ...
              <RefreshCw
                size={16}
                className={`text-slate-600 dark:text-gray-400 ${analyticsLoading ? 'animate-spin' : ''
                  }`}
              />
          ...
          return (
            <div
              ...
              <div className='flex items-center justify-between mb-4'>
                ...
                <div
                  className={`flex items-center text-sm font-medium px-2 py-1 rounded-full ${stat.changeType === 'increase'
                      ...
                      <div className='flex items-start justify-between'>
                        <div className='flex-1'>
                          <div className='flex items-center space-x-2 mb-1'>
                            <div
                              className={`w-5 h-5 rounded-full flex items-center justify-center text-white text-xs font-bold ${index === 0
                                ? 'bg-yellow-500'
                                : index === 1
                                  ? 'bg-gray-400'
                                  : index === 2
