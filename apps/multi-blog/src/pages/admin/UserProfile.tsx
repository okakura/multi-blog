        ...
        <div className="px-6 py-4 border-b border-slate-200 dark:border-gray-700">
          ...
          <div className="flex space-x-8 mt-6">
            <button
              ...
              className={`pb-4 border-b-2 font-medium text-sm transition-colors ${activeTab === 'profile'
            ...
            <button
              ...
              className={`pb-4 border-b-2 font-medium text-sm transition-colors ${activeTab === 'preferences'
                ? 'border-purple-500 text-purple-600 dark:text-purple-400'
                : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300'
                }`}
            >
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`p-3 rounded-lg border-2 transition-all ${preferences.appearance.theme === value
